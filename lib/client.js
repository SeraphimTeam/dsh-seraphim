                              ...
                              children: [
                                ...
                                ...section.groups.map((group) => {
                                  ...
                                  return jsxs("button", {
                                    ref: itemRef,
                                    type: "button",
                                    className: `dsh-seraphim-provider-row${active ? " is-active" : ""}`,
                              ...
                              children: [
                                ...
                                activeProvider.models.map((model) => {
                                  ...
                                  return jsxs("button", {
                                    ref: itemRef,
                                    type: "button",
                                    className: `dsh-seraphim-model-option${selected ? " is-selected" : ""}`,
                                    ...
                                    children: [jsxs("span", { style: styles.modelItemCopy, children: [jsx("span", { style: styles.modelName, children: model.name }), model.description ? jsx("span", { style: styles.modelDescription, children: model.description }) : null] }), jsx("span", { className: "dsh-seraphim-model-check", style: styles.modelCheck, children: selected ? jsx(ModelCheck, {}) : null })],
