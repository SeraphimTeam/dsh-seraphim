window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function CardShell({ open, onToggle, logo, logoBg, title, intro, pill, children }) {
      return jsxs("div", {
        style: styles.card,
        children: [
          jsxs("button", {
    ...
    function SeraphimSection({ t, tClaudeCode, tFreebuff, tCommandcode, tZed, tCodex }) {
      ...
      return jsx("div", {
        ...
        children: [
          ...
          jsx(ClaudeCodeCard, { t: tClaudeCode }, "claude-code"),
          jsx(FreeBuffCard, { t: tFreebuff }, "freebuff"),
          jsx(CommandCodeCard, { t: tCommandcode }, "commandcode"),
          jsx(ZedCard, { t: tZed }, "zed"),
          jsx(CodexCard, { t: tCodex }, "codex"),
        ],
      });
    }
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject("settings.section", () => ctx.slots.register({
        ...
        label: () => t("tab.label"),
        locale: namespace,
        inject: () => ({ t, tClaudeCode, tFreebuff, tCommandcode, tZed, tCodex }),
      }, SeraphimSection));
    }
