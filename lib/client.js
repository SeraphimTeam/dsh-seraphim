window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const styles = {
      ...
      modelProviderButtonActive: { background: "var(--dsw-alias-interactive-bg-hover)" },
      modelLogo: { width: 24, height: 24, flex: "0 0 auto", objectFit: "contain", borderRadius: 6 },
      ...
      modelOptionSelected: { background: "var(--dsw-alias-interactive-bg-hover-accent, var(--dsw-alias-interactive-bg-hover))" },
                    ...
                    children: [
                      ...
                      state.status === "loading" && state.groups.length === 0
                        ...
                        : state.groups.length === 0
                          ...
                          : jsx("div", { style: styles.modelList, children: state.groups.map((group) => {
                              const logo = providerLogo(group.id);
                              ...
                              return jsxs("button", {
                                ...
                                children: [logo ? jsx("img", { src: logo, alt: "", style: styles.modelLogo }) : jsx("span", { "aria-hidden": "true", style: styles.modelProviderFallback, children: group.name.slice(0, 1) }), jsxs("span", { style: styles.modelItemCopy, children: [jsx("span", { style: styles.modelProviderName, children: group.name }), jsx("span", { style: styles.modelProviderMeta, children: `${group.models.length} ${copy("models")}` })] })],
                              }, group.id);
                            }) }),
                    ],
                  }),
